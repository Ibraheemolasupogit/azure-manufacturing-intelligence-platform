...
The final release layer consumes tracked milestone evidence and produces a portfolio evidence index, report index, architecture index, data catalogue, model and analytics catalogue, dashboard catalogue, GenAI catalogue, Azure reference catalogue, repository health summary, validation summary, release manifest, release lineage, and interview/CV/recruiter reports.

The release layer is a consolidation and validation milestone only. It does not add new models, dashboards, GenAI functionality, cloud deployment, or external service calls.
